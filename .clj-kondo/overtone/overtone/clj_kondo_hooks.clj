    ...
    (->>
     ...
     (filter
      (fn*
       [p1__27118#]
       (and
        (= (api/tag p1__27118#) :list)
        (contains?
         #{:ar :dr :ir :kr}
         (:k (first (:children p1__27118#)))))))
     (mapv (fn* [p1__27119#] (:k (first (:children p1__27119#)))))
     set))
   new-node
   (api/list-node
    (list*
            ...
            (api/coerce
             (api/vector-node
              (->>
               ...
               :children
               (filter
                (fn* [p1__27120#] (= (api/tag p1__27120#) :token)))
               (mapcat
                (fn
                 [token]
                 [token
...
(def
 ...
 '{overtone.sc.ugens/impulse:ar {:arglists ([& _]), :special? true},
   ...
   overtone.algo.chance/chosen-from {:arglists ([notes])},
   ...
   overtone.music.pitch/unison {:arglists ([freq__16869__auto__])},
   ...
   overtone.music.pitch/min-sixth {:arglists ([freq__16869__auto__])},
   ...
   overtone.music.pitch/third {:arglists ([freq__16869__auto__])},
   ...
   overtone.music.pitch/fourth {:arglists ([freq__16869__auto__])},
   ...
   {:arglists ([& _]), :special? true},
   overtone.music.pitch/octave {:arglists ([freq__16869__auto__])},
   ...
   overtone.music.pitch/fifth {:arglists ([freq__16869__auto__])},
   ...
   overtone.music.pitch/min-third {:arglists ([freq__16869__auto__])},
   ...
   overtone.music.pitch/sixth {:arglists ([freq__16869__auto__])},
...
(comment
 (->>
  ...
  (remove empty?)
  (mapv
   (fn* [p1__27121#] (clojure.string/replace p1__27121# #"\(do" "")))
  ...
  (mapv
   (fn*
    [p1__27122#]
    (->>
     (clojure.string/split p1__27122# #"defn")
     (mapv clojure.string/trim)))))
 ())
